...
@section('title', 'Create Operate Location | ' . config('app.name'))
            ...
            <div class="row clearfix">
                <div class="col-md-9">
                    <div class="heading-block border-0">
                        <h3><a href='{{ route('operate-locations.index') }}'>Operate Locations</a> > Create a new
                            Location</h3>
                    ...
                    <div class="row clearfix">
                        <div class="col">
                            ...
                            <form class="js-validation-signin" method="POST"
                                  action="{{ route('operate-locations.store')}}">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <i class="icon-location cursor-pointer show-map"></i>
                                                    </span>
                                                </div>
                                                @error('address')
                                                <div class="invalid-feedback">
                                            ...
                                            <span><a class="show-map" href="#">Have no operation address yet? Drop a pin to define an approximate location</a></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <hr/>
                                <div style="display: none" id="map-wrapper">
