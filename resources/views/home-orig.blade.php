...
<head>
	...
	<!-- Title -->
    <title>Home | Just Share Media Roofing</title>
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo"><img src="assets/images/logo.png" alt="Just Share Roofing Media Logo"></a>
						</div><!-- #logo end -->
									...
									<div class="top-cart-items">
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="assets/demoimages/shop/small/1.jpg" alt="Blue Round-Neck Tshirt" /></a>
											</div>
										...
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="assets/demoimages/shop/small/6.jpg" alt="Light Blue Denim Dress" /></a>
											</div>
											<div class="top-cart-item-desc">
												<div class="top-cart-item-desc-title">
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide dark">
							...
							<div class="video-wrap">
								<video id="slide-video" poster="assets/demoimages/videos/explore-poster.jpg" preload="auto" loop autoplay muted>
									<source src='assets/demoimages/videos/explore.webm' type='video/webm' />
									<source src='assets/demoimages/videos/explore.mp4' type='video/mp4' />
								</video>
		...
		<section id="content">
			<div class="content-wrap">
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-7 align-self-end">
							...
							<div class="position-relative overflow-hidden">
								<img src="assets/demoimages/services/main-fbrowser.png" data-animate="fadeInUp" data-delay="100" alt="Chrome">
								<img src="assets/demoimages/services/main-fmobile.png" style="top: 0; left: 0; min-width: 100%; min-height: 100%;" data-animate="fadeInUp" data-delay="400" alt="iPhone" class="position-absolute">
							</div>
				...
				<div class="container clearfix">
					...
					<div class="row col-mb-50 mb-4">
						...
						<div class="col-lg-4 d-md-none d-lg-block text-center">
							<img src="assets/demoimages/services/iphone7.png" alt="iphone 2">
						</div>
				...
				<div class="row clearfix align-items-stretch">
					...
					<div class="col-lg-6 center col-padding" style="background: url('assets/demoimages/services/main-bg.jpg') center center no-repeat; background-size: cover;">
					</div>
					...
					<div class="col-lg-6 center col-padding" style="background-color: #F5F5F5;">
						...
						<div class="center bottommargin">
							<a class="d-block position-relative" href="https://vimeo.com/101373765" data-lightbox="iframe">
								<img src="assets/demoimages/services/video.jpg" alt="Video">
				...
				<div id="portfolio" class="portfolio row no-gutters portfolio-reveal grid-container">
						...
						<div class="grid-inner">
							<div class="portfolio-image">
								<a href="portfolio-single.html">
									<img src="assets/demoimages/portfolio/4/1.jpg" alt="Open Imagination">
								</a>
								<div class="bg-overlay">
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										<a href="assets/demoimages/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
					...
					<article class="portfolio-item col-6 col-md-4 col-lg-3 pf-illustrations">
						<div class="grid-inner">
							<div class="portfolio-image">
								<a href="portfolio-single.html">
									<img src="assets/demoimages/portfolio/4/2.jpg" alt="Locked Steel Gate">
								</a>
								<div class="bg-overlay">
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										<a href="assets/demoimages/portfolio/full/2.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
										<a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="icon-line-ellipsis"></i></a>
									</div>
									<div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item"></div>
								</div>
					...
					<article class="portfolio-item col-6 col-md-4 col-lg-3 pf-graphics pf-uielements">
						<div class="grid-inner">
							<div class="portfolio-image">
								<a href="#">
									<img src="assets/demoimages/portfolio/4/3.jpg" alt="Mac Sunglasses">
								</a>
								<div class="bg-overlay">
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
					...
					<article class="portfolio-item col-6 col-md-4 col-lg-3 pf-icons pf-illustrations">
						<div class="grid-inner">
							<div class="portfolio-image">
								<a href="portfolio-single.html">
									<img src="assets/demoimages/portfolio/4/4.jpg" alt="Open Imagination">
								</a>
								<div class="bg-overlay" data-lightbox="gallery">
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										<a href="assets/demoimages/portfolio/full/4.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
										<a href="assets/demoimages/portfolio/full/4-1.jpg" class="d-none" data-lightbox="gallery-item"></a>
										<a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="icon-line-ellipsis"></i></a>
									</div>
									<div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item"></div>
								</div>
					...
					<article class="portfolio-item col-6 col-md-4 col-lg-3 pf-uielements pf-media">
						<div class="grid-inner">
							<div class="portfolio-image">
								<a href="portfolio-single.html">
									<img src="assets/demoimages/portfolio/4/5.jpg" alt="Console Activity">
								</a>
								<div class="bg-overlay">
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										<a href="assets/demoimages/portfolio/full/5.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
										<a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="icon-line-ellipsis"></i></a>
									</div>
									<div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item"></div>
								</div>
					...
					<article class="portfolio-item col-6 col-md-4 col-lg-3 pf-graphics pf-illustrations">
						<div class="grid-inner">
							<div class="portfolio-image">
								<a href="portfolio-single.html">
									<img src="assets/demoimages/portfolio/4/6.jpg" alt="Open Imagination">
								</a>
								<div class="bg-overlay" data-lightbox="gallery">
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										<a href="assets/demoimages/portfolio/full/6.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
										<a href="assets/demoimages/portfolio/full/6-1.jpg" class="d-none" data-lightbox="gallery-item"></a>
										<a href="assets/demoimages/portfolio/full/6-2.jpg" class="d-none" data-lightbox="gallery-item"></a>
										<a href="assets/demoimages/portfolio/full/6-3.jpg" class="d-none" data-lightbox="gallery-item"></a>
						...
						<div class="grid-inner">
							<div class="portfolio-image">
								<a href="portfolio-single-video.html">
									<img src="assets/demoimages/portfolio/4/7.jpg" alt="Backpack Contents">
								</a>
								<div class="bg-overlay">
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
					...
					<article class="portfolio-item col-6 col-md-4 col-lg-3 pf-graphics">
						<div class="grid-inner">
							<div class="portfolio-image">
								<a href="portfolio-single.html">
									<img src="assets/demoimages/portfolio/4/8.jpg" alt="Sunset Bulb Glow">
								</a>
								<div class="bg-overlay">
									<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
										<a href="assets/demoimages/portfolio/full/8.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
										<a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="icon-line-ellipsis"></i></a>
									</div>
									<div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item"></div>
								</div>
				...
				<div class="container clearfix">
					...
					<div class="row align-items-center col-mb-50">
						<div class="col-md-4 center">
							<img data-animate="fadeInLeft" src="assets/demoimages/services/iphone6.png" alt="Iphone">
						</div>
				...
				<div class="section parallax dark mb-0" style="background-image: url('assets/demoimages/services/home-testi-bg.jpg'); padding: 100px 0;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
							...
							<div class="slider-wrap">
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="assets/demoimages/testimonials/3.jpg" alt="Customer Testimonails"></a>
									</div>
								...
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="assets/demoimages/testimonials/2.jpg" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
								...
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="assets/demoimages/testimonials/1.jpg" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
				...
				<div class="container">
					<div class="row posts-md col-mb-30">
						...
						<div class="col-lg-3 col-md-6">
							<div class="entry">
								<div class="entry-image">
									<a href="#"><img src="assets/demoimages/magazine/thumb/1.jpg" alt="Image"></a>
								</div>
						...
						<div class="col-lg-3 col-md-6">
							<div class="entry">
								<div class="entry-image">
									<a href="#"><img src="assets/demoimages/magazine/thumb/2.jpg" alt="Image"></a>
								</div>
								<div class="entry-title title-xs nott">
						...
						<div class="col-lg-3 col-md-6">
							<div class="entry">
								<div class="entry-image">
									<a href="#"><img src="assets/demoimages/magazine/thumb/3.jpg" alt="Image"></a>
								</div>
								<div class="entry-title title-xs nott">
						...
						<div class="col-lg-3 col-md-6">
							<div class="entry">
								<div class="entry-image">
									<a href="#"><img src="assets/demoimages/magazine/thumb/4.jpg" alt="Image"></a>
								</div>
								<div class="entry-title title-xs nott">
					...
					<div class="container clearfix">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="assets/demoimages/team/3.jpg" alt="John Doe">
									</div>
							...
							<div class="col-lg-3 col-md-6 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="assets/demoimages/team/2.jpg" alt="Josh Clark">
									</div>
									<div class="team-desc team-desc-bg">
							...
							<div class="col-lg-3 col-md-6 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="assets/demoimages/team/8.jpg" alt="Mary Jane">
									</div>
									<div class="team-desc team-desc-bg">
							...
							<div class="col-lg-3 col-md-6 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="assets/demoimages/team/4.jpg" alt="Nix Maxwell">
									</div>
									<div class="team-desc team-desc-bg">
				...
				<div class="container clearfix">
					...
					<div id="oc-clients" class="owl-carousel image-carousel carousel-widget" data-margin="60" data-loop="true" data-nav="false" data-autoplay="5000" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5" data-items-xl="6">
						...
						<div class="oc-item"><a href="#"><img src="assets/demoimages/clients/1.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="assets/demoimages/clients/2.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="assets/demoimages/clients/3.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="assets/demoimages/clients/4.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="assets/demoimages/clients/5.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="assets/demoimages/clients/6.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="assets/demoimages/clients/7.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="assets/demoimages/clients/8.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="assets/demoimages/clients/9.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="assets/demoimages/clients/10.png" alt="Clients"></a></div>
							...
							<div class="row col-mb-50">
								<div class="col-md-4">
									...
									<div class="widget clearfix">
										...
										<img src="assets/demoimages/footer-widget-logo.png" alt="Image" class="footer-logo">

										<p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible</strong> Design Standards.</p>

										<div style="background: url('assets/demoimages/world-map.png') no-repeat center center; background-size: 100%;">
											<address>
