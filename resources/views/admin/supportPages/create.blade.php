...
@section('title', 'Create Support Page | ' . config('app.name'))
        ...
        <div class="row clearfix">
            ...
            <div class="col-md-9">
                ...
                <div class="heading-block border-0">
                    <h3><a href='{{ route('support-pages.index') }}'>Support Pages</a> > Create a new Support Page</h3>
                ...
                <div class="row clearfix">
                    <div class="col">
                        ...
                        <form class="js-validation-signin" method="POST" action="{{ route('support-pages.store')}}">
                            @csrf
                            <div class="row">
                                <div class="col">
